...
def create_dataset(
  ...
  if name == 'market1501':
    im_dir = ospeu('/home/puhaowang/Desktop/MSc_Project/BPM_code/Dataset/market1501/images')
    partition_file = ospeu('/home/puhaowang/Desktop/MSc_Project/BPM_code/Dataset/market1501/partitions.pkl')

  elif name == 'cuhk03':
    im_type = ['detected', 'labeled'][0]
    im_dir = ospeu(ospj('/home/puhaowang/Desktop/MSc_Project/BPM_code/Dataset/cuhk03', im_type, 'images'))
    partition_file = ospeu(ospj('/home/puhaowang/Desktop/MSc_Project/BPM_code/Dataset/cuhk03', im_type, 'partitions.pkl'))   # (PW)need to be modified

  elif name == 'duke':
    im_dir = ospeu('/home/puhaowang/Desktop/MSc_Project/BPM_code/Dataset/duke/images')
    partition_file = ospeu('/home/puhaowang/Desktop/MSc_Project/BPM_code/Dataset/duke/partitions.pkl')

  elif name == 'combined':
    assert part in ['trainval'], \
      "Only trainval part of the combined dataset is available now."
    im_dir = ospeu('/home/puhaowang/Desktop/MSc_Project/BPM_code/Dataset/market1501_cuhk03_duke/trainval_images')
    partition_file = ospeu('/home/puhaowang/Desktop/MSc_Project/BPM_code/Dataset/market1501_cuhk03_duke/partitions.pkl')
