...
class Config(object):
  def __init__(self):
    ...
    # sys device id
    parser.add_argument('-d', '--sys_device_ids', type=eval, default=())   # default=(0,)
    parser.add_argument('-r', '--run', type=int, default=1)
    parser.add_argument('--set_seed', type=str2bool, default=False)
    parser.add_argument('--dataset', type=str, default='market1501',
                        choices=['market1501', 'cuhk03', 'duke', 'combined'])   # change datasets
    parser.add_argument('--trainset_part', type=str, default='trainval',
                        choices=['trainval', 'train'])                          # change for train or validate
    ...
    parser.add_argument('--batch_size', type=int, default=64)   # change the batch size
...
def main():
  ...
  TVT, TMO = set_devices(cfg.sys_device_ids)    # modify: GPU or CPU=-1
